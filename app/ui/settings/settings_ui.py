...
class SettingsPageUI(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.value_mappings = {
            ...
            self.tr("Gemini-3.1-Flash-Lite"): "Gemini-3.1-Flash-Lite",
    ...
    def _init_ui(self):
        ...
        self.skia_text_checkbox = self.tools_page.skia_text_checkbox
        ...
        self.prompt_preset_combo = self.llms_page.prompt_preset_combo
